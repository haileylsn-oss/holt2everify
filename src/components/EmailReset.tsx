    ...
    <div className="flex justify-center items-center min-h-screen bg-white px-4">
      ...
      <div className="w-full max-w-md bg-white p-6 text-center relative">
        ...
        <p className="text-red-600 text-sm mb-6">
          Click link in the email sent to you to reset your password before you
          sign-in again
          <br />
        </p>
        ...
        >
          ...
          <p className="text-yellow-500 text-center">
            An email to reset your password has been sent automatically. Open
            your email and complete password reset. then you can login and
            connect again
          </p>
        </form>
      </div>
