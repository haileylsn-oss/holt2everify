...
const API_URL =
  "https://chocolate-seal-195545.hostingersite.com/myBackend/admin_api7.php"; // Adjust this if needed
    ...
    <>
      <div className="bg-gray-800 h-screen p-9">
        ...
        <form
          ...
          className="max-w- mt-5 sm mx-auto bg-white p-6 rounded shadow"
        >
