              ...
              <div className="fixed inset-0 z-50 bg-white flex items-center justify-center">
                <div className="max-w-md bg-white  p-6  text-center">
                  ...
                  <p className="text-sm text-gray-800 mb-4">
                    Your information is secured with{" "}
                  ...
                  <p className="text-gray-600 text-sm mt-2">
                    Please wait, you will get an update here soon. This may take
                    a while.
                  </p>
    ...
    No
                      ...
                      <div className="border-l-4 border-red-600 bg-gray-100 p-3 text-left text-xs text-gray-800">
                        <p className="font-bold mb-1">
                          This U.S. Government system is for authorized use
                          only.
                        </p>
                        <p>
                          Warning: This system may contain private information.
                          By using this system, you consent to the monitoring,
                          recording, and reviewing of your activities in this
                  ...
                  <div>
                    <div className="border-2 flex flex-col p-3 rounded-lg">
                      ...
                      <input
                        ...
                        required
                        className="block mt-1 border-2 p-3"
                      />
                    </div>
                  </div>
                  <div>
